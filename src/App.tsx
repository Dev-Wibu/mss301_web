...
const StaffDashboardPage = lazy(() =>
  import("@/pages/staff/StaffDashboardPage").then((m) => ({
            ...
            <Routes>
              ...
              >
                ...
                <Route
                  ...
                  element={<StaffPaymentManagerPage />}
                />
                <Route
                  path={ROUTES.STAFF_FEEDBACK}
                  element={<StaffFeedbackManagerPage />}
                />
              </Route>
              ...
              />
              <Route
                path={ROUTES.GATEWAY_TIMEOUT}
                element={<GatewayTimeoutPage />}
              />
