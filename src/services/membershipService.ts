  ...
  getMembershipInfo: async (): Promise<MembershipInfo> => {
    if (USE_MOCK_API) {
      ...
      return {
        ...
        tier: "silver",
        transactions: [
          { id: 1, type: "earned", points: 640, description: "Đơn hàng TG-20260228-001", createdAt: "2026-02-25T10:00:00Z" },
          { id: 2, type: "earned", points: 7020, description: "Đơn hàng TG-20260227-002", createdAt: "2026-02-27T10:00:00Z" },
          { id: 3, type: "redeemed", points: 500, description: "Đổi điểm giảm giá 500.000đ", createdAt: "2026-02-20T14:00:00Z" },
        ],
      };
    }
