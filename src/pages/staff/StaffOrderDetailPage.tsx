  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild><Link to="/staff/orders"><ArrowLeft className="h-4 w-4" /></Link></Button>
        <div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader><CardTitle className="text-base">Liên hệ khách hàng</CardTitle></CardHeader>
            <CardContent className="text-sm">
              <p className="font-medium">{order.shippingInfo.recipientName}</p>
              <p className="text-gray-500">{order.shippingInfo.phone}</p>
              <p className="mt-2 text-gray-500">{order.shippingInfo.streetAddress}, {order.shippingInfo.ward}, {order.shippingInfo.district}, {order.shippingInfo.province}</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-gray-500">Thanh toán</span><span className="uppercase">{order.paymentMethod}</span></div>
